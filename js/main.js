(function () {
    ...
    $(function(){
        ...
        simplyCountdown('#countdown', {
            ...
            plural: true,
            inline: false, // Set to true if you want inline countdown
            refresh: 1000, // Refresh every second (1000 ms)
            zeroPad: true, // Zero pad single digits
            onEnd: function() {
                console.log("The wedding day has arrived!");
